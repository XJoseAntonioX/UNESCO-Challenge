import { ArrowRight, BarChart3, BookOpen, Bot, Globe2, Send, ShieldCheck } from 'lucide-react'
      ...
      <section className="hero">
        <div className="hero-copy">
          ...
          <small className="trust">
            <ShieldCheck size={16} />
            Evidencia visible. Fuentes consultables. Decisiones informadas.
          </small>
        </div>
        <div className="modules">
          <button className="window bot-window" onClick={() => navigate('chat')}>
          ...
          <div className="mini-stack">
            <button className="window mini-window" onClick={() => navigate('learn')}>
              <i>
                <BookOpen size={20} />
              </i>
            ...
            <button className="window mini-window" onClick={() => navigate('dashboard')}>
              <i className="coral">
                <BarChart3 size={20} />
              </i>
